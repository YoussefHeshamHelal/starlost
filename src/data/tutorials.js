...
export const LEVEL_TUTORIALS = {
  ...
  7: [
    levelStep('level-7-repeat-forward', {
      ...
      body: 'Instead of adding four MOVE FORWARD blocks, use REPEAT 4 with MOVE FORWARD inside. This makes the program more efficient.',
      waitForTarget: true,
      nextLabel: 'Got it',
    }),
...
export const FEATURE_TUTORIALS = {
  ...
  'facing-question': [
    featureStep('facing-question-intro', 'facing-question', {
      ...
      requiresAction: true,
      actionLabel: 'Pick the correct LUMA picture',
