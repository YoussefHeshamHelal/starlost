...
const THEMES = {
  ...
  dark: {
    ...
    scrollBorder: 'rgba(255,255,255,0.66)',
    emptyText: '#d7e8f6',
    btnBorder: 'rgba(255,255,255,0.62)',
    btnColor: '#eaf6ff',
    btnDisabled: '#b9d0e3',
    railBg: '#0a1828',
    railBorder: 'rgba(255,255,255,0.66)',
    tickColor: '#dbeafe',
    speedLabelClr: '#eaf6ff',
    visorBg: 'rgba(139,92,246,0.14)',
    visorBorder: '#a78bfa',
    visorText: '#c4b5fd',
    visorExhBg: 'rgba(6,10,18,0.7)',
    visorExhBd: 'rgba(255,255,255,0.45)',
    visorExhTx: '#b8cbe0',
    ...
    runBorderDisabled: 'rgba(255,255,255,0.55)',
    runColorActive: '#2dd4bf',
    runColorDisabled: '#b9d0e3',
