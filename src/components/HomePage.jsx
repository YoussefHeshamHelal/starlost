...
const HOME_MAPS = [
  ...
  { id: 'repair-site', title: 'Repair Site', levels: [11, 12, 13, 14, 15], accent: 'violet' },
]
          ...
          >
            <div style={{ maxWidth: 760 }}>
              ...
              <p style={{
                ...
                Crash Site, Forest Trail, and the first three Repair Site missions are live now.
              </p>
            </div>
                      ...
                      {isLiveMap
                        ? mapConfig.id === 'crash-site'
                          ...
                          : mapConfig.id === 'forest-trail'
                            ...
                            : 'Reach the repair bay, collect every fragment, and learn IF BOX AHEAD.'
