...
const HOME_MAPS = [
  ...
  { id: 'launch-site', title: 'Launch Site', levels: [11, 12, 13, 14, 15], accent: 'violet' },
]
          ...
          >
            <div style={{ maxWidth: 760 }}>
              ...
              <p style={{
                ...
                Crash Site, Forest Trail, and the first two Launch Site missions are live now.
              </p>
            </div>
                      ...
                      {isLiveMap
                        ? mapConfig.id === 'crash-site'
                          ...
                          : mapConfig.id === 'forest-trail'
                            ...
                            : 'Reach the launch pad, collect every fragment, and learn IF BOX AHEAD.'
